...
const NavigationBar = () => {
  ...
  const iconData = [
    {
      iconName: 'chat',
      imageSource: require('../../../../assets/navBar/chat.png'),
    },
    {
      iconName: 'basket',
      imageSource: require('../../../../assets/navBar/basket.png'),
    },
    {
      iconName: 'calendar',
      imageSource: require('../../../../assets/navBar/calendar.png'),
    },
    {
      iconName: 'save',
      imageSource: require('../../../../assets/navBar/save.png'),
    },
    {
      iconName: 'gear',
      imageSource: require('../../../../assets/navBar/gear.png'),
    },
  ];
